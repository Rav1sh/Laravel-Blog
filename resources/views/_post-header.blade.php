<header class="max-w-xl mx-auto mt-20 text-center">
    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div x-data="{ show:false }" @click.away="show = false">
            ...
            <div x-show="show" class="py-2 absolute bg-gray-100 mt-2 rounded-xl w-full z-index 50" style="display:none">
                ...
                @foreach($categories as $category)
                    <a href="/categories/{{ $category->slug }}"
                       class="block text-left px-3 text-sm leading-6 hover:bg-gray-300 focus:bg-gray-300 {{ isset($currentCategory) && $currentCategory->id === $category->id ? 'bg-gray-300' : ''}}">
